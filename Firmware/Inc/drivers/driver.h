...
#define DRIVER_DECLARE(TYPE, NAME)                            \
    extern TYPE NAME##_Internal TARG_SHARED_MEM_DATA_SECTION; \
...
#define DRIVER_DECLARE_ARRAY(TYPE, NAME, SIZE)                           \
    extern TYPE NAME##_InternalArray[SIZE] TARG_SHARED_MEM_DATA_SECTION; \
...
// clang-format off
#define DRIVER_DEFINE(TYPE, NAME)             TYPE NAME##_Internal TARG_SHARED_MEM_DATA_SECTION
#define DRIVER_DEFINE_ARRAY(TYPE, NAME, SIZE) TYPE NAME##_InternalArray[SIZE] TARG_SHARED_MEM_DATA_SECTION
// clang-format on
