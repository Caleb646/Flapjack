...
#define CFG_DEFINE(TYPE, NAME) TYPE NAME##_Internal TARG_SHARED_MEM_DATA_SECTION
#define CFG_DEFINE_ARRAY(TYPE, NAME, SIZE) \
    TYPE NAME##_InternalArray[SIZE] TARG_SHARED_MEM_DATA_SECTION
