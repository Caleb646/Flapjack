...
FJ_TESTABLE DmaDevice_t* Dma_GetOrCreate (void) {
...
//     Plat_Dma_SetEnabled (pDmaDevice, false);
//     Plat_Dma_SetTransferCfg (pDmaDevice, srcAddr, dstAddr, size);
//     Plat_Dma_SetInterruptsEnabled (pDmaDevice, true);
//     Plat_Dma_SetEnabled (pDmaDevice, true);
//     return eSTATUS_OK;
// }
