...
TARG_SHARED_MEM_DATA_SECTION TimHwCfg_t e_TimHwCfgs[] = { { .id            = eTIM_1_DEVICE_ID,
                                                            .pInstance     = TIM1,
...
TARG_SHARED_MEM_DATA_SECTION uint8_t e_nTimHwCfgs = sizeof (e_TimHwCfgs) / sizeof (e_TimHwCfgs[0]);
