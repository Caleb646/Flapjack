...
static DeviceBoardConf_t currentSensor = { .deviceId = eCURRENT_SENSOR_DEVICE_ID,
                                           .generic = { NULL, &i2c1 } };
