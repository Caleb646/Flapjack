...
)
{
    ...
    float norm; 
    float SEqDot_omega_1, SEqDot_omega_2, SEqDot_omega_3, SEqDot_omega_4;   // quaternion derrivative from gyroscopes elements float 
    float f_1, f_2, f_3;                                                    // objective function elements 
    float J_11or24, J_12or23, J_13or22, J_14or21, J_32, J_33; 
    float SEqHatDot_1, SEqHatDot_2, SEqHatDot_3, SEqHatDot_4;               // Axulirary variables to avoid reapeated calcualtions 
    ...
    SEqHatDot_4 = J_14or21 * f_1 + J_11or24 * f_2; 
     ...
     norm = 1.0f / sqrt(SEqHatDot_1 * SEqHatDot_1 + SEqHatDot_2 * SEqHatDot_2 + SEqHatDot_3 * SEqHatDot_3 + SEqHatDot_4 * SEqHatDot_4); 
     SEqHatDot_1 *= norm; 
     SEqHatDot_2 *= norm; 
     SEqHatDot_3 *= norm; 
     SEqHatDot_4 *= norm;
     ...
     pOutputAttitude->roll = atan2(q0 * q1 + q2 * q3, 0.5f - q1 * q1 - q2 * q2) * 57.29577951f;
