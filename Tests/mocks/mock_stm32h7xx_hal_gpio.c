...
typedef struct _CMOCK_HAL_GPIO_Init_CALL_INSTANCE
{
  ...
  const GPIO_InitTypeDef* Expected_GPIO_Init;
...
static struct mock_stm32h7xx_hal_gpioInstance
{
...
void mock_stm32h7xx_hal_gpio_Verify(void)
{
...
void mock_stm32h7xx_hal_gpio_Init(void)
{
  mock_stm32h7xx_hal_gpio_Destroy();
}

void mock_stm32h7xx_hal_gpio_Destroy(void)
{
...
void HAL_GPIO_Init(GPIO_TypeDef* GPIOx, const GPIO_InitTypeDef* GPIO_Init)
{
  ...
  }
  {
    ...
    UNITY_TEST_ASSERT_EQUAL_MEMORY((void*)(cmock_call_instance->Expected_GPIO_Init), (void*)(GPIO_Init), sizeof(const GPIO_InitTypeDef), cmock_line, CMockStringMismatch);
  }
  UNITY_CLR_DETAILS();
}

void CMockExpectParameters_HAL_GPIO_Init(CMOCK_HAL_GPIO_Init_CALL_INSTANCE* cmock_call_instance, GPIO_TypeDef* GPIOx, const GPIO_InitTypeDef* GPIO_Init);
void CMockExpectParameters_HAL_GPIO_Init(CMOCK_HAL_GPIO_Init_CALL_INSTANCE* cmock_call_instance, GPIO_TypeDef* GPIOx, const GPIO_InitTypeDef* GPIO_Init)
{
...
void HAL_GPIO_Init_CMockExpect(UNITY_LINE_TYPE cmock_line, GPIO_TypeDef* GPIOx, const GPIO_InitTypeDef* GPIO_Init)
{
